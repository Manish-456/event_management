        ...
        <div className="flex w-full flex-col gap-8 p-5 md:p-10">
            ...
            <div className="flex flex-col gap-5">
                <div className="flex gap-2 md:gap-3">
                    ...
                    <div className="p-regular-20 flex gap-2 md:gap-3 items-center">
                        <Image
            ...
            <div className="flex flex-col gap-2">
                ...
                <Link href={event.url} target="_blank" className="p-medium-16 lg:p-regular-18 truncate text-primary-500 underline">
                    {event.url}
                </Link>
